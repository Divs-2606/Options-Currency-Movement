...
#Start of HTML and Callbacks

#Using Dash for creating app structure and setting the basic design and layout built on flask and React
...
# Start of callbacks, integrating python algo with app structure
